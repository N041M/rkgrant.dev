...
- `assets/js/field.js` draws the moving glyph background. On the first screen the car drives past a coastline city, a bridge, farmland, mountains, a desert and a forest while the day turns to night. The ridgeline plot sits behind the rest of the page and water runs under the footer.
